...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 21 Jun 2025 pada 18.20
...
--
-- Struktur dari tabel `camera_attendances`
--

CREATE TABLE `camera_attendances` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `user_id` bigint(20) UNSIGNED NOT NULL,
...
(114, '2024_11_05_135202_create_locations_table', 1),
(115, '2024_11_05_135224_create_attendances_table', 1),
(116, '2025_05_11_150722_create_camera_attendances_table', 1);
...
--
-- Indeks untuk tabel `camera_attendances`
--
ALTER TABLE `camera_attendances`
  ADD PRIMARY KEY (`id`),
  ADD KEY `camera_attendances_user_id_foreign` (`user_id`);
...
--
-- AUTO_INCREMENT untuk tabel `camera_attendances`
--
ALTER TABLE `camera_attendances`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Ketidakleluasaan untuk tabel `camera_attendances`
--
ALTER TABLE `camera_attendances`
  ADD CONSTRAINT `camera_attendances_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
COMMIT;
